    ...
    <div className="bg-yellow-400 font-mono">
      ...
      <section className="mb-1 ml-4 mr-4 rounded-3xl py-20">
        <div className="about-me-section p-8">
          ...
          <p className="text-lg mb-4">Hello, I'm a Front-end Developer with a passion for creating interactive and dynamic web applications. With over 3 years of experience in the industry, I have developed a deep understanding of modern web technologies and design principles.</p>
          ...
          <p className="mb-4">In my free time, I enjoy Tennis, hiking, and experimenting with new web technologies.</p>
        </div>
      </section>
      ...
      <section className="ml-4 mr-4 rounded-2xl py-20">
